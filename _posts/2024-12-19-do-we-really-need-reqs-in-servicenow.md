...
<style>
  /* REQ/RITM/Task hierarchy diagram */
  .hierarchy-visual {
    margin: 1.5rem 0;
    padding: 1.5rem;
    background: var(--bg-2);
  ...
  .req-card {
    background: var(--bg);
    border: 2px solid var(--snow-brown);
    border-radius: 8px;
    padding: 1rem;
  ...
  .pros-section { border-left: 4px solid var(--mint); }
  .cons-section { border-left: 4px solid var(--pink); }
  ...
  .pro-icon { color: var(--mint); }
  .con-icon { color: var(--pink); }
  ...
  .related-post h3 a:hover { color: var(--snow-brown); }
